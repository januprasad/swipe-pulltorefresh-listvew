...
public class SwipeListViewTouchListener implements View.OnTouchListener {
    ...
    private int swipeMode = SwipePulltoRefreshListView.SWIPE_MODE_BOTH;
    ...
    private int swipeCurrentAction = SwipePulltoRefreshListView.SWIPE_ACTION_NONE;

    private int swipeActionLeft = SwipePulltoRefreshListView.SWIPE_ACTION_REVEAL;
    private int swipeActionRight = SwipePulltoRefreshListView.SWIPE_ACTION_REVEAL;
     ...
     */
    public SwipeListViewTouchListener(SwipePulltoRefreshListView swipeListView, int swipeFrontView, int swipeBackView) {
    ...
    protected boolean isSwipeEnabled() {
        return swipeMode != SwipePulltoRefreshListView.SWIPE_MODE_NONE;
    }
    ...
    private void swapChoiceState(int position) {
        ...
        if (lastCount == 0 && count == 1) {
            ...
            closeOpenedItems();
            setActionsTo(SwipePulltoRefreshListView.SWIPE_ACTION_CHOICE);
        }
    ...
    private void generateAnimate(final View view, final boolean swap, final boolean swapRight, final int position) {
        ...
        if (swipeCurrentAction == SwipePulltoRefreshListView.SWIPE_ACTION_REVEAL) {
            generateRevealAnimate(view, swap, swapRight, position);
        }
        if (swipeCurrentAction == SwipePulltoRefreshListView.SWIPE_ACTION_DISMISS) {
            generateDismissAnimate(parentView, swap, swapRight, position);
        }
        if (swipeCurrentAction == SwipePulltoRefreshListView.SWIPE_ACTION_CHOICE) {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (MotionEventCompat.getActionMasked(motionEvent)) {
            case MotionEvent.ACTION_DOWN: {
                ...
                swipeCurrentAction = SwipePulltoRefreshListView.SWIPE_ACTION_NONE;
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (!opened.get(downPosition)) {
                    if (swipeMode == SwipePulltoRefreshListView.SWIPE_MODE_LEFT && velocityTracker.getXVelocity() > 0) {
                        velocityX = 0;
                    }
                    if (swipeMode == SwipePulltoRefreshListView.SWIPE_MODE_RIGHT && velocityTracker.getXVelocity() < 0) {
                        velocityX = 0;
                    }
                }
...
//                }
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (swipeMode == SwipePulltoRefreshListView.SWIPE_MODE_NONE) {
                    deltaMode = 0;
                } else if (swipeMode != SwipePulltoRefreshListView.SWIPE_MODE_BOTH) {
                    if (opened.get(downPosition)) {
                        if (swipeMode == SwipePulltoRefreshListView.SWIPE_MODE_LEFT && deltaX < 0) {
                            deltaMode = 0;
                        } else if (swipeMode == SwipePulltoRefreshListView.SWIPE_MODE_RIGHT && deltaX > 0) {
                            deltaMode = 0;
                        }
                    } else {
                        if (swipeMode == SwipePulltoRefreshListView.SWIPE_MODE_LEFT && deltaX > 0) {
                ...
                if (deltaMode > slop && swipeCurrentAction == SwipePulltoRefreshListView.SWIPE_ACTION_NONE && velocityY < velocityX) {
                    swiping = true;
                    ...
                    if (opened.get(downPosition)) {
                        ...
                        swipeCurrentAction = SwipePulltoRefreshListView.SWIPE_ACTION_REVEAL;
                    } else {
                        if (swipingRight && swipeActionRight == SwipePulltoRefreshListView.SWIPE_ACTION_DISMISS) {
                            swipeCurrentAction = SwipePulltoRefreshListView.SWIPE_ACTION_DISMISS;
                        } else if (!swipingRight && swipeActionLeft == SwipePulltoRefreshListView.SWIPE_ACTION_DISMISS) {
                            swipeCurrentAction = SwipePulltoRefreshListView.SWIPE_ACTION_DISMISS;
                        } else if (swipingRight && swipeActionRight == SwipePulltoRefreshListView.SWIPE_ACTION_CHOICE) {
                            swipeCurrentAction = SwipePulltoRefreshListView.SWIPE_ACTION_CHOICE;
                        } else if (!swipingRight && swipeActionLeft == SwipePulltoRefreshListView.SWIPE_ACTION_CHOICE) {
                            swipeCurrentAction = SwipePulltoRefreshListView.SWIPE_ACTION_CHOICE;
                        } else {
                            swipeCurrentAction = SwipePulltoRefreshListView.SWIPE_ACTION_REVEAL;
                        }
    ...
    public void move(float deltaX) {
        ...
        } else if (swipeCurrentAction == SwipePulltoRefreshListView.SWIPE_ACTION_CHOICE) {
